...
const FACULTY: FacultyMember[] = [
  ...
  {
    name: 'Senior Maritime Instructor',
    rank: 'Chief Engineer & Technical Lead',
    specialization: 'Marine Engineering, GME & ETO Technical Coaching & Marine Machinery',
  ...
  {
    name: 'Senior Maritime Mentor',
    rank: 'Interview & Personality Specialist',
    specialization: 'Personality Grooming, Company Sponsorship Mock Interviews & SSB Guidance',
    seaTime: '12+ Years Mentorship Experience',
    companies: 'Leading Shipping Lines',
    credential: 'Chief Mentorship Officer',
    icon: ShieldCheck,
    color: '#0F2C59',
  ...
  },
  {
    ...
    specialization: 'Applied Mathematics for IMU-CET, Physics & Aptitude Reasoning',
