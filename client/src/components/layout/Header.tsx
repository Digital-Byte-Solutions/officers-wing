          ...
          <div className="hidden lg:block bg-[#0F2C59] text-white text-xs py-1.5 px-6 border-b border-navy-dark transition-all duration-300">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
              <div className="flex items-center space-x-6">
                <a href="tel:+919557381578" className="flex items-center gap-1.5 text-white/90 hover:text-[#F59E0B] transition-colors">
                  <Phone className="w-3.5 h-3.5 text-[#F59E0B]" /> +91 95573 81578
                </a>
                <a href="mailto:admissions@officerswing.com" className="flex items-center gap-1.5 text-white/90 hover:text-[#F59E0B] transition-colors">
